  ...
  render() {
    return (
      <div>
        ...
        <StepNav />
        <Container>
          <H3 py="3rem">Conditions of Service</H3>
          <Hero>
            <div className="row">
          ...
          <SplitGrid leftWidth={30} rightWidth={70} id="split-grid">
            ...
            <SplitGridRightColumn>
              ...
              <LegalSection id="general-conditions">
              ...
              <LegalSection id="conditions-of-engagement">
                ...
                <h3>Letter of Appointment</h3>
                  <h4>
                  The Company shall issue a letter of appointment to all
                  ...
                  The Employee shall also sign the appropriate
               ...
               <Table mb="2rem" width="70%">
                 ...
                 <tbody>
                  ...
                  Executive and Human Resource Executive. 
                  </h4>
                  <h4>
                  Where an
                  ...
                  <h4>
                  Probation feedback will be obtained
                  ...
                  At part of the requirements to be considered
                ...
                <h3>Appraisal</h3>
                  ...
                  <h4>
                  All merit salary increases shall be
                  based on the Employee’s performance appraisal results.
                  </h4>
                  <h4>
                ...
                <h3>Salary</h3>
                  ...
                  Salaries shall be paid on monthly basis in arrears.
                  </h4>
                  <h4>
                  Deductions by statutory requirement or repayment due to
                ...
                <h3>Service and Place of Employment</h3>
                  <h4>
                  Whilst in the employment of the Company the Employee
                  ...
                  <h4>
                  An Employee may request for transfer from
              ...
              <LegalSection id="working-hours-and-overtime">
                ...
                There shall be a maximum of forty (40) hours of work to
                  ...
                  <h4>
                  Each Employee shall be entitled to an hour’s break for
                ...
                <h3>Overtime</h3>
                <h4>
                An Employee who is required to work in excess of the
              ...
              <LegalSection id="benefits">
                ...
                Salary advance may be granted to staff who have been
                  ...
                  conforms to maximum monthly deduction stipulations. 
                </h4>
                <h4>
                The
                  Company may grant an interest free salary advance to Employees
                  to enable them to meet urgent financial obligations.
                </h4>
                <h4>
                The
                ...
                <h4>
                The Employee shall undertake to
                ...
                Every
                  ...
                  agree to be bound by the rules of the fund.
                </h4>
                <h4>
                For the
                ...
                <h3>Out of Station Expenses</h3>
                  ...
                  <h4>
                  An Employee who undertakes an authorized trip outside
              ...
              <LegalSection id="leave-or-absence">
                <h2>LEAVE OR ABSENCE</h2>
                <h3>Annual Vacation</h3>
                <h4>
                Subject to the existing MTN Ghana Leave Policy,
                ...
                Subject to the existing MTN Ghana Leave Policy,
                  ...
                  28 working days respectively after five years’ service.
                </h4>
                <h4>
                ...
                <h4>
                Where an Employee resigns from his
                  ...
                  equivalent value in cash paid to the Employee.
                </h4>
                <h4>
                When
                ...
                <h4>
                The MTN Ghana Leave Policy and the provisions
                ...
                <h4>
                A period of absence from work may be granted to an
                ...
                <h4>
                All applications for compassionate leave shall be made
                ...
                <h4>
                An Employee who is absent from work for reasons of
                ...
                <h4>
                The Line Manager must be provided
                  ...
                  decline to pay for the sick leave taken (unpaid leave).
                </h4>
                <h4>
                Notwithstanding the above any Employee absent on sick leave on
                  ...
                  decline to pay for the sick leave taken.
                </h4>
                <h4>
                The Company
                ...
                <h4>
                Subject to (5.5.1) above, Employees
              ...
              <LegalSection id="medical-care">
                ...
                <h3>
                The Company shall be responsible for medical
                ...
                <h3>
                Medical policy may be subject to change at
              ...
              <LegalSection id="leaving-the-service">
                <h2>Leaving the Service</h2>

                <h3>Termination</h3>
                <h4>
                An employee wishing to terminate his/her appointment
                ...
                <h3>Interdiction (Suspension)</h3>
                  ...
                  <h4>
                  All Employees shall be subject to the Disciplinary Code
                  of the Company.
                  </h4>
                  <h4>
                  Should an Employee be suspected of
                ...
                <h4>
                An Employee shall be summarily dismissed by the Company
                  ...
                  <h5>
                  Continuous failure to report to work or at duty post
                  on time without just cause,
                  </h5>
                  <h5>
                  Fighting or physically
                  ...
                  <h5>
                  Passing on confidential information to any
                  unauthorized person without the approval of the appropriate
                  authority,
                  </h5>
                  <h5>
                  Willful refusal to obey legitimate
                  instructions without reasonable excuse,
                  </h5>
                  <h5>
                  Dereliction of
                  ...
                  and or its image into disrepute.
                  </h5>
                </h4>
                <h4>
                  In all cases the
                  ...
                  <h4>
                  An Employee who is summarily dismissed shall
                ...
                <h4>
                An Employee shall not be absent from work without
                ...
                <h4>
                Except during lunch hours, an Employee shall not leave
                  the place of work during working hours without permission.
                </h4>
                <h4>
An Employee who absents himself/herself from duty
                ...
                The Company
                  ...
                  at the age of fifty-five (55) years. 
                </h4>
                <h4>
                An employee
              ...
              <LegalSection id="miscellaneous-conditions">
                ...
                <h4>
                The Employee shall not within one year of termination of
                  his employment directly or indirectly on his own or on behalf
                  of any other person:

                  <h5>
                  Solicit or approach any person to
                  ...
                  <h5>
                  Solicit or approach any person to whom he/she knows
                  ...
                  those then sold or supplied by the Company. 
                  </h5>
                  <h5>
                  Seek to
                ...
                All Employees in Level 3 and
                  ...
                  competitor of the Company situated in Ghana.
                </h4>
                <h4>
                All
                  ...
                  within the MTN Group of companies. 
                </h4>
                <h4>
                The Employee
                ...
                <h4>
                If any provision of clause 8.2 herein is
                ...
                <p>
                The Employee shall perform his
                ...
                <p>
                <h4>
                Extraneous or Part-time Employment
                </h4>
                </p>
                <h5>
                All Employees are obliged to devote to the Company
                  ...
                  Company pursuant to the contract of employment.
                </h5>
                <h5>
                An
                ...
                <h4>
                The Company shall have the sole right to exercise all
